...
{
	static WebDriver driver;private static String url = "https://www.goindigo.in/?linkNav=home_header";
	//Setup Driver
	@BeforeClass
	...
	public void Booking()
	{
		...
		WebDriverWait waitElement = new WebDriverWait(driver,20);waitElement.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"bookingWidgetContainer\"]/div/div/div/div[1]/div[2]/button")));
